...
### Methodeanwendung:
Zur Anwendung einer der beiden Methode in dem Experiment kann man die Umgebungsvariable in `docker-compose.yml` setzen (`APPLY_INTER_PACKET_TIMES` für t1 oder `APPLY_SIZE_MODULATION` für s1). Für Beispiel siehe `docker-compose.yml`
